void fit_a2(int i_a=2){
  ...
  Double_t ysigma=2.0;
  //Double_t yc[5]={-7.5, -2.5, 5.0, 12.5, 17.5}; 4045 a3-a5
  Double_t yc[5]={-7.5, 2.5, 10.0, 20.0, 30.0};
  ...
  c3->cd();
  //gStyle->SetStatH(3);
  TH1F *hy=new TH1F("hy","hy",300,-50,100);
