...
void chi2(Int_t &npar, Double_t *gin, Double_t &f, Double_t *par, Int_t iflag){
  ...
  for(int i=0; i<loop; i++){
    ...
    double func3 = 0;
    double func4 = 0;
    func1 = par[0]+par[1]*data[0][i]+par[2]*data[1][i]+par[3]*data[2][i]+par[4]*data[3][i];
    func2 = par[5]*pow(data[0][i],2)+par[6]*pow(data[1][i],2)+par[7]*pow(data[2][i],2)+par[8]*pow(data[3][i],2.0);
    func3 = par[9]*data[0][i]*data[1][i]+par[10]*data[1][i]*data[2][i]+par[11]*data[2][i]*data[0][i]+par[12]*data[0][i]*data[3][i]+par[13]*data[1][i]*data[3][i]+par[14]*data[2][i]*data[3][i];
    func4=par[15]*pow(data[1][i],3.0)+par[16]*pow(data[1][i],4.0)+par[17]*pow(data[1][i],5.0);
    //+par[10]*data[0][i]*data[1][i]*data[2][i];
    ...
    double val1 = b[0]+b[1]*data[0][i]+b[2]*data[1][i]+b[3]*data[2][i];
    double val2 = b[4]*pow(data[0][i],2)+b[5]*pow(data[1][i],2)+b[6]*pow(data[2][i],2);
    double val3 = b[7]*data[0][i]*data[1][i]+b[8]*data[1][i]*data[2][i]+b[9]*data[2][i]*data[0][i]+b[10]*data[0][i]*data[1][i]*data[2][i];
    */
    //if(abs(data[4][i]-val1-val2-val3)<5.0){
...
int phi_fit_minuit_mp(){
  ...
  for(int i=0;i<loop;i++){
    Double_t val1 = par[0]+par[1]*data[0][i]+par[2]*data[1][i]+par[3]*data[2][i]+par[4]*data[3][i];
    Double_t val2 = par[5]*pow(data[0][i],2)+par[6]*pow(data[1][i],2)+par[7]*pow(data[2][i],2)+par[8]*pow(data[3][i],2.0);
    Double_t val3 = par[9]*data[0][i]*data[1][i]+par[10]*data[1][i]*data[2][i]+par[11]*data[2][i]*data[0][i]+par[12]*data[0][i]*data[3][i]+par[13]*data[1][i]*data[3][i]+par[14]*data[2][i]*data[3][i];
    Double_t val4 = par[15]*pow(data[1][i],3.0)+par[16]*pow(data[1][i],4.0)+par[17]*pow(data[1][i],5.0);
