{
  ...
  TString file_root[n_file]={"run4188.hist.root","run4189.hist.root","run4190.hist.root","run4191.hist.root","run4192.hist.root","run4193.hist.root","run4194.hist.root","run4195.hist.root","run4196.hist.root"};
