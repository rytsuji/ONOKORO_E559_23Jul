{
  ...
  ht->SetYTitle("y_{fp}^{corrected} (mm)");
  ...
  tree->Draw("gr.fYc:vdc_gr_m.fA*1000>>ht",pid_proton && xcut,"colz");


  c1->SaveAs("figs/output_macro/sieve_gr/ayc_run4040.pdf");
  c1->SaveAs("figs/output_macro/sieve_gr/ayc_run4040.png");
