{
  ...
  //Def Histgram
  TH2F *ht1 = new TH2F("ht","GR Y-B after correction",200,-25,25,200,-30,30);
  ...
  tree->Draw("vdc_gr_m.fB*1000:gr.fYc>>ht",pid_proton,"colz");


  c1->SaveAs("figs/output_macro/yb_gr/yb_corrected.pdf");
  c1->SaveAs("figs/output_macro/yb_gr/yb_corrected.png");
