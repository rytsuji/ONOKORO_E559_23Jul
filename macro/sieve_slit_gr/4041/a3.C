{
  ...
  TString  dir ="/home/tsuji/work/art_analysis/e559_23jul/macro/sieve_slit_gr/4041/result/a3/";  
  ...
  //x fitting
  tree->Draw("vdc_gr_m.fX>>hx3(300,-200,400)",acut,"");
  ...
  c2->cd();
  tree->Draw("vdc_gr_m.fA*1000>>ha3(300,-100,200)",xcut,"");
  ...
  for(int i=0;i<5;i++){
    ...
    hX[i]=new TH1F(Form("hX[%d]",i),Form("hX[%d]",i),300,-200,400);
    tree->Draw(Form("vdc_gr_m.fX>>hX[%d]",i),Form("abs(vdc_gr_m.fY-%e)<%e",y_center,2*y_sigma) && xcut,"");
    ...
    c5->cd();
    c5->cd(i+1);
    hA[i]=new TH1F(Form("hA[%d]",i),Form("hA[%d]",i),300,-200,400);
    tree->Draw(Form("vdc_gr_m.fA*1000>>hA[%d]",i),Form("abs(vdc_gr_m.fY-%e)<%e",y_center,y_sigma) && acut,"");
