{
  ...
  TString fname = "macro/yb_gr/x_4206.dat";
  ...
  TF1 *f[3];
  //Double_t x_min[4]={-120,-40,220,480};
  //Double_t x_max[4]={-60,50,270,530};
  Double_t x_min[3]={-120,-40,220};
  Double_t x_max[3]={-60,50,270};
  ...
  c1->SaveAs("figs/output_macro/yb_gr/x_4206.pdf");
  c1->SaveAs("figs/output_macro/yb_gr/x_4206.png");
}
