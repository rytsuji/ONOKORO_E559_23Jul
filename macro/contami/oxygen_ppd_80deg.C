{
  double ratio = 0.428;
  double BC_mylar=58637.0;
  double BC_carbon=63982.6;
  double scale=-1.0/10.0;

  TFile *file_mylar = TFile::Open("output/phys/run4214.hist.root");
  ...
  TFile *file_carbon = TFile::Open("output/phys/run4213.hist.root");
