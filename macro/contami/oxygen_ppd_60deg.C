{
  double ratio = 0.428;
  double BC_mylar=111145.6;
  double BC_carbon=121512.0;
  double scale=-1.0/12.0;

  TFile *file_mylar = TFile::Open("output/phys/run4110.hist.root");
  ...
  TFile *file_carbon = TFile::Open("output/phys/run4109.hist.root");
