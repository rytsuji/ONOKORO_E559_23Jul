...
ClassImp(art::TVDCTrackingXZRotatableProcessor)

art::TVDCTrackingXZRotatableProcessor::TVDCTrackingXZRotatableProcessor()
...
void art::TVDCTrackingXZRotatableProcessor::Process()
{
...
void art::TVDCTrackingXZRotatableProcessor::ProcessOne(const std::vector<TVDCCluster*>& planes)
{
...
void art::TVDCTrackingXZRotatableProcessor::FindTrack(const std::vector<TVDCCluster*>& planes, TMWDCTrackingResult *tr, bool doFillStat)
{
  ...
  // Info("FindTrack","enter");
   ...
   if (fNParameter == 2) {
     ...
     TVector3 pos(bestTrackPrm[0],bestTrackPrm[1],0);
     TVector3 vec(bestTrackPrm[2],bestTrackPrm[3],1);
//      vec.Print();


     pos.RotateX(fTiltedAngleX*TMath::DegToRad());      
     pos.RotateY(fTiltedAngleY*TMath::DegToRad());
     pos.RotateZ(fTiltedAngleZ*TMath::DegToRad());//      vec.Print();
