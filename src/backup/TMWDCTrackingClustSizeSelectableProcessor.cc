/**
 * @file   TMWDCTrackingClustSizeSelectableProcessor.cc
 * @brief
 *
...
using art::TMWDCTrackingClustSizeSelectableProcessor;

ClassImp(art::TMWDCTrackingClustSizeSelectableProcessor);

// Default constructor
TMWDCTrackingClustSizeSelectableProcessor::TMWDCTrackingClustSizeSelectableProcessor()
...
void TMWDCTrackingClustSizeSelectableProcessor::Init(TEventCollection *col)
{
...
void TMWDCTrackingClustSizeSelectableProcessor::GenerateMatrix()
{
...
void TMWDCTrackingClustSizeSelectableProcessor::Process()
{
   {/* initialization */
      fStopwatch->Start();
...
void TMWDCTrackingClustSizeSelectableProcessor::ProcessOne(const std::vector<std::vector<TMWDCHitData*> >& planeData)
{
   fNPlaneValid = 0;
   fCombinator->Clear();
   for (Int_t iPlane = 0; iPlane != fNPlane; ++iPlane) {
...
Int_t TMWDCTrackingClustSizeSelectableProcessor::FindBestCombination(TMWDCTrackingResult *tr)
{
...
Bool_t TMWDCTrackingClustSizeSelectableProcessor::DataIsValid(const TMWDCHitData *planeData) const
{
   {
...
Bool_t TMWDCTrackingClustSizeSelectableProcessor::CombinationIsValid() const
{
   return kTRUE;
}

void TMWDCTrackingClustSizeSelectableProcessor::FindTrack(TMWDCTrackingResult *tr, Bool_t fillStat)
{
...
Double_t TMWDCTrackingClustSizeSelectableProcessor::CalcSSR(const std::vector<Double_t> &pos,
