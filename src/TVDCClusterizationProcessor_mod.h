...
namespace art {
   class TVDCClusterizationProcessor_mod;
   class TConverterBase;
   class TMWDCHitData;
}

class art::TVDCClusterizationProcessor_mod : public TProcessor {
public:
   // Default constructor
   TVDCClusterizationProcessor_mod();
   virtual ~TVDCClusterizationProcessor_mod();
...
//   TVDCClusterizationProcessor_mod_original(const TVDCClusterizationProcessor_mod_original& rhs);
   // Assignment operator (prohibited)
   //TVDCClusterizationProcessor_mod_original& operator=(const TVDCClusterizationProcessor_mod_original& rhs);

   ClassDef(TVDCClusterizationProcessor_mod,0) // processor for MWDC plane division
};
