...
using art::TTimeTrefValidator;

ClassImp(TTimeTrefValidator)

TTimeTrefValidator::TTimeTrefValidator()
{
...
TTimeTrefValidator::TTimeTrefValidator(const TTimeTrefValidator& rhs)
{
}

TTimeTrefValidator& TTimeTrefValidator::operator=(const TTimeTrefValidator& rhs)
{
   if (this != &rhs) {
...
void TTimeTrefValidator::Init(TEventCollection *col)
{
...
void TTimeTrefValidator::Process()
{
   fOutput->Clear("C");
